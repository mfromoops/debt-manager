...
The Flutter app still stores loan data locally in `shared_preferences`. This Worker stores one sync document per authenticated WorkOS user and lets devices pull/push that document opportunistically.
